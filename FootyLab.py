...
ROLES = [None,"Coach Gus", "Dashley", "Kellan", "AyMarri"]
allroles = ["Coach Gus", "Dashley", "Kellan", "AyMarri"]
...
aymarri = st.Page(
    ...
    title="AyMarri's App",
    icon=":material/school:",
    default=(user == "AyMarri")
)

account_pages = [logout_page, settings]
explore_pages = [BootRoom, prosoccer]
build_pages = [codeBox, coachGus]
deployed_pages = [classpage, kellan, dashley, aymarri]
